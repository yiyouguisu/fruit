                            ...
                            <tr>
                                ...
                                <td>
                                  <ul class="switch_list cc ">
                                    <li>
                                        <label><input type='radio' name='type' value='1' checked><span>链接广告</span></label>
                                    </li>
                                    <li>
                                        <label><input type='radio' name='type' value='2' ><span>商品广告</span></label>
                                    </li>
                                    <li>
                                        <label><input type='radio' name='type' value='3' ><span>图文广告</span></label>
                                    </li>
                                  </ul>
                                </td>
                            </tr>
