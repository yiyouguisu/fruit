...
<div class="wrap J_check_wrap">
        ...
        <form method="get" action="{:U('Admin/apply/company')}">
                    ...
                    <volist name="data" id="vo">
                        <tr>
                            ...
                            <td align="center" > 
                              ...
                              <if condition="authcheck('Admin/Company/add')">
              <a href="{:U('Admin/Company/add',array('applyid'=>$vo['id']))}" >分配账号</a> 
                <else/>
                 <font color="#cccccc">分配账号</font>
              </if> 
            </eq>
          </eq>
            <eq name="vo['status']" value="1">
                                <if condition="authcheck('Admin/apply/companyreview')">
              <a href="javascript:;" onClick="omnipotent('selectid','{:U('Admin/apply/companyreview',array('id'=>$vo['id']))}','审核',1,700,400)">审核</a>
                <else/>
                 <font color="#cccccc">审核</font>
              </if> 
              </eq>
                            <if condition="authcheck('Admin/apply/companydelete')">
              <a href="{:U('Admin/apply/companydelete',array('id'=>$vo['id']))}"  class="del">删除</a> 
                <else/>
            ...
            <div class="btn_wrap">
                <div class="btn_wrap_pd">
                    <label class="mr20"><input type="checkbox" class="J_check_all" data-direction="y" data-checklist="J_check_y">全选</label>   
                        ...
                        <if condition="authcheck('Admin/apply/companydel')">
