                ...
                <div class="table_full">
                    <table width="100%" class="table_form contentWrap">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                  <ul class="switch_list cc ">
                                    <li>
                                        <label><input type='checkbox' name='isnew' value='1' checked><span>新闻</span></label>
                                    </li>
                                    <li>
                                        <label><input type='checkbox' name='isrecruit' value='1'><span>招聘</span></label>
                                    </li>
                                    <li>
                                        <label><input type='checkbox' name='isload' value='1' ><span>资料下载</span></label>
                                    </li>
                                  </ul>
                                </td>
                            </tr>
                            ...
                            <tr id="load">
                                <th>资料文件</th>
                                <td><input type="text" name="file" id="file" class="input length_5" value="" style="float: left"  runat="server" >&nbsp; <input type="button" class="button" value="选择上传" id="uploadify2" ></td>
                            </tr>

                            <tr id="img">
                                <th>文章图片：</th>
                                <td><input type="text" name="thumb" id="image" class="input length_5" value="" style="float: left"  runat="server" ondblclick='image_priview(this.value);'>&nbsp; <input type="button" class="button" value="选择上传" id="uploadify" > <span class="gray"> 双击文本框查看图片</span></td>
                            </tr>
