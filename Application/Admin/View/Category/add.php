...
<include file="Common:Nav"/>
  ...
  <form name="myform" id="myform" action="{:U('Admin/Category/add')}" method="post" enctype="multipart/form-data">
          ...
          <table width="100%" class="table_form ">
            <tr>
              ...
              <td><select name="modelid" id="modelid">
                  ...
                  <option value="2" <if condition=" $parentid_modelid eq 2"> selected</if>>列表模块</option>
                  <option value="1" <if condition=" $parentid_modelid eq 1"> selected</if>>单页模块</option>
                </select></td>
            </tr>
            <tr>
            ...
            <tr>
              <th>栏目缩略图：</th>
              <td><input type="text" name="image" id="image" class="input length_5" value=""  runat="server" style="float: left"   ondblclick='image_priview(this.value);'> &nbsp; <input type="button" class="button" value="选择上传" id="uploadify" >
