...
<body class="J_scroll_fixed">
    <div class="wrap J_check_wrap">
        ...
        <form name="myform" id="myform" action="{:U('Admin/Category/edit')}" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <div class="table_full">
                        <table width="100%" class="table_form ">
                            ...
                            <tr>
                                <th>栏目缩略图：</th>
                                <td><input type="text" name="image" id="image" class="input length_5" value="{$data.image}"  runat="server" style="float: left"  ondblclick='image_priview(this.value);' > &nbsp;  <input type="button" class="button" value="选择上传" id="uploadify" ><span class="gray"> 双击文本框查看图片</span></td>
                            </tr>
                            <tr>
                                <th>链接地址：</th>
