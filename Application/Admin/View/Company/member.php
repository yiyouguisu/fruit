   ...
   <table width="100%" cellspacing="0">
       <thead>
          <tr>
            ...
            <td width="10%"  align="center" >登陆次数</td>
        ...
        <foreach name="data" item="vo">
          <tr>
            ...
            <td align="center">{$vo.username|default="<span style='color:gray'>未填写</span>"}</td>
            <td align="center">{$vo.nickname|default="<span style='color:gray'>未填写</span>"}</td>
            <td align="center">
              <if condition="$vo.sex eq 0"><span style='color:gray'>未知</span></if>
              <if condition="$vo.sex eq 1">男</if>
              <if condition="$vo.sex eq 2">女</if>
            </td>
            <td align="center" >{$vo.phone|default="<span style='color:gray'>未填写</span>"}</td>
            <td align="center">
              <empty name="vo.lastlogin_time">
                <span style='color:gray'>用户还未登录</span>
                <else />
            ...
            <td align="center">
              ...
              <if condition="$vo.status eq 1">开启</if>
            </td>
            <td align="center" >{$vo.reg_time|date="Y-m-d H:i:s",###}</td>
            <td  align="center" >
               <a href="{:U('Admin/Company/changestatus',array('id'=>$vo['id']))}" >更新状态 </a> 
            </td> 
          </tr>
         </foreach>
        </tbody>
