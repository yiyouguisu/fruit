                                ...
                                <td>
                                    <ul class="switch_list cc ">
                                        <li style="width: 130px;">
                                            <label>
                                                <input type='radio' name='type' value='0' checked><span>默认</span></label>
                                        </li>
                                        <li style="width: 130px;">
                                            <label>
                                                <input type='radio' name='type' value='1'><span>适用于某个店铺</span></label>
                                        </li>
                                        <li style="width: 130px;">
                                            <label>
                                                <input type='radio' name='type' value='2'><span>适用于某件商品</span></label>
                                        </li>
                                        <li style="width: 130px;">
                                            <label>
                                                <input type='radio' name='type' value='3'><span>适用于某种分类商品</span></label>
                                        </li>
                                    </ul>
                                </td>
                            </tr>
