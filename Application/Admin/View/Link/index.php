...
<body class="J_scroll_fixed">
    <div class="wrap J_check_wrap">
        ...
        <form method="post" action="{:U('Admin/Link/index')}">
        ...
        <form action="{:U('Admin/Link/action')}" method="post" >
            <div class="table_list">
                <table width="100%" cellspacing="0">
                    ...
                    <volist name="data" id="vo">
                        ...
                        <if condition="authcheck('Admin/Link/edit')">
                            <a href="{:U('Admin/Link/edit',array('id'=>$vo['id']))}" >修改</a>
                            <else/>
                            <font color="#cccccc">修改</font>
                        </if>
                        <if condition="authcheck('Admin/Link/delete')">
                            <a href="{:U('Admin/Link/delete',array('id'=>$vo['id']))}" class="del" >删除</a>
                            <else/>
