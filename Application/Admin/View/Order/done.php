                 ...
                 <?php $money_total1=0;?>
                    <volist name="data" id="vo">
                        <tr class="productshow" data-id="{$vo.id}">
                            ...
                            <td align="center" >
                                <eq name="vo['isfeedback']" value="1"><span style="color:green;">[已反馈]</span></eq>
                                [<a href="javascript:;" data-href="{:U('Admin/Order/download',array('orderid'=>$vo['orderid']))}" onclick="image_priview('{$vo.ordercode}');">查看二维码</a>]{$vo.orderid}
                            </td>
                            ...
                            <td align="center" > 
                                ...
                                <!-- <a href="{:U('Admin/Order/show',array('orderid'=>$vo['orderid']))}">查看详情</a> -->
                            </td>
                        </tr>
