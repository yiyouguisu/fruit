...
<include file="Common:Head" /><body class="J_scroll_fixed">
    <div class="wrap J_check_wrap">
        ...
        <form action="{:U('Admin/Order/paynotices')}" method="post" >
                 ...
                 <?php $money_total1=0;?>
                    <volist name="data" id="vo">
                        <tr class="productshow" data-id="{$vo.id}">
                            ...
                            <td align="center" > 
                                <a href="{:U('Admin/Order/paynotice',array('orderid'=>$vo['orderid']))}">提示支付</a></br>
                                <a href="{:U('Admin/Order/cancel',array('orderid'=>$vo['orderid']))}" class="cancel">取消订单</a>
                            </td>
                        </tr>
