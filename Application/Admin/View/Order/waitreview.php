...
<include file="Common:Head" /><body class="J_scroll_fixed">
    <div class="wrap J_check_wrap">
        ...
        <form action="{:U('Admin/Order/doreviews')}" method="post" >
            <div class="table_list">
                 ...
                 <?php $money_total1=0;?>
                    <volist name="data" id="vo">
                        <tr class="productshow" data-id="{$vo.id}">
                            ...
                            <td align="center" > 
                                <a href="{:U('Admin/Order/doreview',array('orderid'=>$vo['orderid']))}">审核通过</a></br>
                                <a href="{:U('Admin/Order/cancel',array('orderid'=>$vo['orderid']))}">取消订单</a>
                            </td>
                        </tr>
                ...
                <div class="p10">
                    ...
                    <button class="btn btn_submit mr10 " type="submit" name="doreviews" value="doreviews">批量审核</button>
