       ...
       <!--  <div class="h_a">搜索</div>
        ...
        <div class="tab_nav" style="margin-bottom:0px">
            <ul class="J_tabs_nav1">
              <li class=""><a href="{:U('Admin/Package/errororder')}">未处理订单</a><i>+{$errornum|default="0"}</i></li>
              <li class="current"><a href="{:U('Admin/Package/errordone')}">已处理订单</a><i>+{$errordonenum|default="0"}</i></li>
            </ul>
        </div>
                            ...
                            <div class="fish_d fl">
                              <if condition="$vo.paystyle eq 1">   
                                ...
                                <if condition="$vo.paystyle eq 2">
                                    ...
                                    <neq name="vo['package_status']" value="2">
                                        <a href="{:U('Admin/Package/packagedone',array('orderid'=>$vo['orderid']))}">包装完成</a>
                                    </neq>
                                </if> 
                                ...
                                <!-- <input type="button" onClick="window.location.href='{:U('Admin/Package/doout',array('orderid'=>$vo['orderid']))}'" value="缺货"> -->
                            </div>
