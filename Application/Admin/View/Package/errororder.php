       ...
       <!--  <div class="h_a">搜索</div>
        ...
        <div class="tab_nav" style="margin-bottom:0px">
            <ul class="J_tabs_nav1">
              <li class="current"><a href="{:U('Admin/Package/errororder')}">未处理订单</a><i>+{$errornum|default="0"}</i></li>
              <li class=""><a href="{:U('Admin/Package/errordone')}">已处理订单</a><i>+{$errordonenum|default="0"}</i></li>
            </ul>
        </div>
                                ...
                                <div class="liv_g fl">
                                    <div class="liv_g1">
                                      ...
                                      <if condition=" $v.product_type eq '4'"> [称重商品]</if>
                                        ...
                                        <eq name="v['isout']" value="1"> <?php $num++ ?><span style="color:red">【缺货】</span></eq>
                            ...
                            <div class="fish_d fl">
                              <if condition="$vo.paystyle eq 1">   
                                    <eq name="vo['pay_status']" value="1">
                                        <eq name="vo['back_status']" value="0">
                                            <a href="{:U('Admin/Package/backorder',array('orderid'=>$vo['orderid']))}">退货</a></br>
                                            <else />
                                            已退货</br>
                                        </eq>
                                        <else />
                                        ...
                                        <eq name="vo['change_status']" value="0">
                                            
                                                    <a href="javascript:;" onClick="omnipotent('selectid','{:U('Admin/Package/changeorder',array('orderid'=>$vo['orderid']))}','换货',1,500,350)">换货</a></br>
                                                    <else />
                                                    已换货</br>
                                           </eq>     
                                        </if>
                                ...
                                <if condition="$vo['pay_status'] eq 0 and $vo['paystyle'] eq 1 ">
                                    <a href="{:U('Admin/Package/paynotice',array('orderid'=>$vo['orderid']))}">提示支付</a></br>
                                   </if> 
                                <if condition="$vo['package_status'] eq 1">
                                    <a href="{:U('Admin/Package/packagedone',array('orderid'=>$vo['orderid'],'iserror'=>1))}">包装完成</a></br>
                                </if>
