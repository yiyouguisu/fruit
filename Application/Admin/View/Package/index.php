       ...
       <!--  <div class="h_a">搜索</div>
        ...
        <div class="tab_nav" style="margin-bottom:0px">
            <ul class="J_tabs_nav1">
              <li class="current"><a href="{:U('Admin/Package/index')}">全部订单</a><i>+{$allnum|default="0"}</i></li>
              ...
              <li class=""><a href="{:U('Admin/Package/packagdone')}">包装完成</a><i>+{$packagdonenum|default="0"}</i></li>
            </ul>
        </div>
                    ...
                    <div class="liv_list">
                        ...
                        <div class="liv_btm">
                            <div class="liv_left fl" style="width: 55%;">
                                            ...
                                            <div class="liv_g fl">
                                                <div class="liv_g1">
                                                  ...
                                                  <if condition=" $v.product_type eq '4'"> [称重商品]</if>
                                                    ...
                                                    <if condition="$v['isout'] eq 1"><span style="color:red">【缺货】</span></if>
                                                    </neq>
                                            </div>
                                        </div>
                                    </volist>
                                ...
                                <neq name="vo['package_status']" value="2">
                                    <input type="button" class="doout" data-url="{:U('Admin/Package/doout',array('orderid'=>$vo['orderid']))}" value="缺货处理">
                                  </neq>  
                                    </div>
