...
<div class="wrap J_check_wrap">
        ...
        <form method="get" action="{:U('Admin/Product/outoff')}">
        ...
        <form action="{:U('Admin/Product/paction')}" method="post" >
            <div class="table_list">
              ...
              <a href="{:U('Admin/Product/review',array('id'=>$vo['id']))}" >审核</a>  |
                <else/>
                 <font color="#cccccc">审核</font> |</if>  -->
              <a href="javascript:;" class="unout" data-id="{$vo['id']}" >取消缺货</a>
            ...
            <div class="btn_wrap">
                <div class="btn_wrap_pd">
                    ...
                    <if condition="authcheck('Admin/Product/unouts')">
                             <button class="btn btn_submit mr10 " type="submit" name="submit" value="unouts">取消缺货</button>
                        </if>
