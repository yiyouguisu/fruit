                    ...
                    <table width="100%" class="table_form contentWrap">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul class="switch_list cc ">
                                        <li>
                                            <label>
                                                <input type='radio' name='type' value='1' checked><span>一般商品</span></label>
                                        </li>
                                        <li>
                                            <label>
                                                <input type='radio' name='type' value='2'><span>团购商品</span></label>
                                        </li>
                                        <li>
                                            <label>
                                                <input type='radio' name='type' value='3'><span>预购商品</span></label>
                                        </li>
                                        <li>
                                            <label>
                                                <input type='radio' name='type' value='4'><span>称重商品</span></label>
                                        </li>
                                    </ul>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="thumb" id="thumb" class="input length_5" value="{$data.thumb}" style="float: left" runat="server" ondblclick='image_priview(this.value);'>&nbsp;
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="extrathumb" id="extrathumb" class="input length_5" value="{$data.extrathumb}" style="float: left" runat="server" ondblclick='image_priview(this.value);'>&nbsp;
