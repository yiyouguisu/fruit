    ...
    <div class="J_tabs_contents">
        ...
        <div class="table_full">
          <table width="100%" class="table_form ">
            ...
            <tr>
              <th>栏目缩略图：</th>
              <td><input type="text" name="thumb" id="image" class="input length_5" value=""  runat="server" style="float: left"   ondblclick='image_priview(this.value);'> &nbsp; <input type="button" class="button" value="选择上传" id="uploadify" >
