...
.header h1{
	background-image:url(__IMG__/logo.gif);background-repeat:no-repeat;width:227px;height:78px;line-height:150px;overflow:hidden;font-size:0}
...
.qzone_cont .scroll_img li{ width:10px;height:10px;background-image:url(__IMG__/qzone_login.png);background-position:-663px 0;background-repeat:no-repeat;display:inline-block;margin-right:15px;cursor:pointer;*display:inline;*zoom:1;overflow:hidden}
.qzone_cont .scroll_img .current_img{ background-image:url(__IMG__/admin_img/qzone_login.png);background-position:-663px -17px}
...
.login_main .login_list .input_txt{border:1px solid #d9d9d9;border-radius:3px;font-size:16px;font-family:"Microsoft Yahei",Tahoma;height:23px;width:259px;color:#666;padding:14px 0 14px 9px;}
...
.login_main .login_btn{ width:148px;height:48px;line-height:150px;overflow:hidden;font-size:0;*background:none;background-image:url(__IMG__/qzone_login.png);background-position:-514px 0;border:none;cursor:pointer}
...
.platform_box nav{ background-image:url(__IMG__/qzone_login.png);background-position:0 0;background-repeat:no-repeat;width:370px;height:52px;margin:0 auto}
...
.footer{ background:#f0f0f0 url(__IMG__/ft_bg.jpg) repeat-x;color:#999}
  ...
  <div class="inner">
    ...
    <div class="qzone_login clearfix">
      <div class="qzone_cont" id="_pt">
        <li><img src="__IMG__/login_bg.jpg" alt="生活以快乐为基准，爱情以互惠为原则！"></li>
      </div>
      <!-- end qzone_cont -->
      <div class="login_main">
        <p class="wrong_notice" id="err_m" style="display:none;"></p>
        <form id="loginform" method="post" name="loginform" action="{:U('Admin/Public/login')}"   >
          <ul class="login_list"  id="web_login">
            <li class="login_input">
              <input  value=""  id="username" name="username"  class="input_txt" tabindex="1"   type="text" value="" title="用户名" data-rule="required;username" data-tip="输入您的用户名！"   placeholder="用户名"/>
              <span class="msg-box n-right" style="position:static;" for="username"></span>
            </li>
            <li class="login_input">
              <input maxlength=16 type="password"  id="password" name="password" tabindex="2"   class="input_txt" type="text" value="" title="密码" data-tip="输入您的密码！"  data-rule="required;password" placeholder="密码"/>
            ...
            <li class="yanzhengma clearfix" id="verifytip"> <span id="verifyinput">
              <input  id="verify" name="verify" maxlength=5 tabindex="3" class="input_txt" type="text" value="" data-ok=" " placeholder="验证码" data-tip="输入验证码！" title="验证码" data-rule="required;text;remote[{:U('Admin/Public/check_verify')}]" />
              </span>
              ...
              <span class="msg-box n-right" style="position:absolute; top: 53px; left: 0px; " for="verify"></span>
...
<div class="footer">
  <div class="inner">
    <div class="copyright clearfix">
      <p class="copyright_en">Copyright &copy; 2014. All Rights Reserved.</p>
      <p class="copyright_ch">后台管理系统</p>
    </div>
  </div>
</div>
