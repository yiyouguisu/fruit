...
<include file="Common:Nav"/>
   ...
   <div class="table_list">
        ...
        <form method="get" action="{:U('Admin/Push/index')}">
        ...
        <form action="{:U('Admin/Push/del')}" method="post" >
        ...
        <foreach name="data" item="vo">
          <tr>
            ...
            <td  align="center" >
                  <a href="{:U('Admin/Push/pushagain',array('id'=>$vo['id']))}">再次推送 </a> |
        ...
        <div class="btn_wrap">
          <div class="btn_wrap_pd">
            ...
            <if condition="authcheck('Admin/Push/del')">
