...
<include file="Common:Nav"/>
   ...
   <div class="table_list">
        ...
        <form method="post" action="{:U('Admin/Store/financial')}">
       ...
       <thead>
        ...
        <foreach name="data" item="vo">
          <tr>
            ...
            <td  align="center" >
                  <if condition="authcheck('Admin/Store/financialedit')">
                            <a href="{:U('Admin/Store/financialedit',array('id'=>$vo['id']))}" >修改基本资料 </a>  |
                            <else/>
                            <font color="#cccccc">修改基本资料</font> |
                        </if>  
                        <if condition="authcheck('Admin/Store/financialdelete')">
                            <a href="{:U('Admin/Store/financialdelete',array('id'=>$vo['id']))}"  class="del">删除 </a> 
                            <else/>
