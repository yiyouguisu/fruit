...
<include file="Common:Nav"/>
   ...
   <div class="table_list">
        ...
        <form method="post" action="{:U('Admin/Store/packing')}">
       ...
       <thead>
        ...
        <foreach name="data" item="vo">
          <tr>
            ...
            <td align="center" >{:getpackageorder_totalmoney($vo['id'])}</td>
            <td align="center" >{:getpackageorder_totalnum($vo['id'])}</td>
            <td  align="center" >
                  <if condition="authcheck('Admin/Store/packingedit')">
                            <a href="{:U('Admin/Store/packingedit',array('id'=>$vo['id']))}" >修改基本资料 </a>  |
                            <else/>
                            <font color="#cccccc">修改基本资料</font> |
                        </if>  
                        <if condition="authcheck('Admin/Store/packingdelete')">
                            <a href="{:U('Admin/Store/packingdelete',array('id'=>$vo['id']))}"  class="del">删除 </a> 
                            <else/>
