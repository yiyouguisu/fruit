...
<include file="Common:Nav"/>
   ...
   <div class="table_list">
        ...
        <form method="post" action="{:U('Admin/Store/stock')}">
       ...
       <thead>
        ...
        <foreach name="data" item="vo">
          <tr>
            ...
            <td  align="center" >
                  <if condition="authcheck('Admin/Store/stockedit')">
                            <a href="{:U('Admin/Store/stockedit',array('id'=>$vo['id']))}" >修改基本资料 </a>  |
                            <else/>
                            <font color="#cccccc">修改基本资料</font> |
                        </if>  
                        <if condition="authcheck('Admin/Store/stockdelete')">
                            <a href="{:U('Admin/Store/stockdelete',array('id'=>$vo['id']))}"  class="del">删除 </a> 
                            <else/>
