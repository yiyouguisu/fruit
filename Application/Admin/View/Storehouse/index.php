...
<div class="wrap J_check_wrap">
        ...
        <form method="get" action="{:U('Admin/Storehouse/index')}">
        ...
        <div class="h_a">企业商品仓库访问链接：<a href="{:U('Admin/Public/storehousecompany',array('storeid'=>$storeid))}" target="_blank">{:C('WEB_URL')}{:U('Admin/Public/storehousecompany',array('storeid'=>$storeid))}</a></div>
        <form action="{:U('Admin/Storehouse/action')}" method="post" >
                ...
                <table width="100%" cellspacing="0">
                    ...
                    <volist name="data" id="vo">
                        <tr>
                            ...
                            <td align="left" ><a href="{$vo.url}" target="_blank">{$vo.url}</a></td>
                            <td align="center" >
                                <if condition="$vo.status eq 0"> <span style="color: red">未审核</span></if>
                                <if condition="$vo.status eq 1"> 已审核</if>
                            </td>
                            <td align="center" > 
                                <if condition="authcheck('Admin/Storehouse/edit')">
             <a href="{:U('Admin/Storehouse/edit',array('id'=>$vo['id']))}" >修改</a>
                <else/>
                 <font color="#cccccc">修改</font>
              </if>
                                <if condition="authcheck('Admin/Storehouse/delete')">
           <a href="{:U('Admin/Storehouse/delete',array('id'=>$vo['id']))}" class="del" >删除</a>
                <else/>
