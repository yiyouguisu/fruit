...
<body>
    ...
    <img src="__IMG__/icon_Locate_minddle.png" style="position: absolute; top: 25%; left: 45%; width: 25px; z-index: 99" />
    <img src="__IMG__/first_location.png" style="position: absolute; top: 40%; left: 85%; width: 50px; z-index: 99" onclick="toinit()" />
    ...
    overflow-y: scroll;
     ...
     .map_a { font-size:1.2rem;position:relative;} 
  ...
  <div class="map_ul">
  	<include file="Address:morelist_index" />
  </div>
</body>
</html>
...
var address="";
    $(function () {
        ...
        $(".map_ul .map_list").live("click",function(){
        	...
        	$.ajax({
               ...
               success: function (data) {
                   ...
                   geoc.getLocation(new BMap.Point(lng,lat), function (rs) {
                       var addComp = rs.addressComponents;
                       address=addComp.street + addComp.streetNumber;
                       $(window.parent.document).find("#address").val(address);
                   });;
               }
           });
        })
