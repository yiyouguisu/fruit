<div id="page_foot" class="page_foot">
       <ul>
          <li class="hover" onclick="window.location.href='{:U('Web/Index/index')}';"><img alt="" src="__IMG__/icon_home_click.png" /><p>首页</p></li>
           <if condition="$place eq '选择店铺'">
                <li class="nomal" onclick="window.location.href='{:U('Web/Product/pempty')}';"><img alt="" src="__IMG__/icon_productsClass_default.png" /><p>分类</p></li>
           <else /> 
                <li class="nomal" onclick="window.location.href='{:U('Web/Product/lists')}';"><img alt="" src="__IMG__/icon_productsClass_default.png" /><p>分类</p></li>
           </if>
