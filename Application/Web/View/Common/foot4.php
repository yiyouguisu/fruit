<div id="page_foot" class="page_foot">
    <img class="cartBox" alt="" src="__IMG__/icon_dayuan.png" onclick="window.location.href='{:U('Web/Cat/lists')}';"/>
    <img class="cartImg" alt="" src="__IMG__/icon_shopping_cart.png" onclick="window.location.href='{:U('Web/Cat/lists')}';"/>
    <span class="cartSz" onclick="window.location.href='{:U('Web/Cat/lists')}';">{$cartcount}</span>
</div>
