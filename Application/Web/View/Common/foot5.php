<div id="page_foot" class="page_foot">
       <ul>
          <li class="share"><img alt="" src="__IMG__/login_logo.png" /></li>
          <li class="share" style="width:50%"><p>下载蔬果先生App,立享更多细致服务！</p></li>
          <li class="share" style="margin-top:15px; text-align:center; " onclick="window.location.href='{:U('Web/Member/invitecode',array('uid'=>I('get.uid')))}';">
             <span>立即体验</span>
          </li>
       </ul>
</div>
