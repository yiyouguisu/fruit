        ...
        <div class="table_full">
          <table width="100%" class="table_form ">
            ...
            <tr>
              ...
              <td>
                <input type="text" name="email_reg_subject" class="input length_6 input_hd" placeholder="请输入邮件主题" id="email_reg_subject" value="{$Site.email_reg_subject}"><span class="gray"><literal>请填写邮件主题</literal></span></br>
             	  <textarea name="email_reg" id="email_reg" style="width:500px;height:120px;">{$Site.email_reg}</textarea>
            ...
            <tr>
              ...
              <td>
                <input type="text" name="email_password_subject" class="input length_6 input_hd" placeholder="请输入邮件主题" id="email_password_subject" value="{$Site.email_password_subject}"><span class="gray"><literal>请填写邮件主题</literal></span></br>
