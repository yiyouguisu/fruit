                ...
                <div class="table_full">
                        <table cellpadding=0 cellspacing=0 width="100%" class="table_form" >
                            <tr>
                                ...
                                <td><input type="text" class="input"  name="jpush_appkey" value="{$Site.jpush_appkey}" size="40"></td>
                            </tr>
                            <tr>
                                <th width="140">极光推送secret:</th>
                                <td><input type="text" class="input"  name="jpush_masterSecret" value="{$Site.jpush_masterSecret}" size="40"></td>
                            </tr>
