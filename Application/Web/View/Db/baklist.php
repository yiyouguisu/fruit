                ...
                <table width="100%" cellspacing="0">
                    ...
                    <volist name="baklist" id="vo">
                        <tr>
                          ...
                          <td align="center" > 
                          <a href="{:U('Admin/Db/delzip',array('file_name'=>$vo['time'],'part'=>$vo['part'],'compress'=>$vo['compress']))}"  class="del">删除</a>|
                          <a href="{:U('Admin/Db/import',array('time'=>$vo['time']))}" >还原</a>|
                          <a href="{:U('Admin/Db/downzip',array('file_name'=>$vo['time'],'part'=>$vo['part'],'compress'=>$vo['compress']))}" >下载</a>
                          </td>
                        </tr>
                    </volist>
                    </tbody>
