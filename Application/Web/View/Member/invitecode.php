    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#page_info").click(function () {
                //location.href = "{:U('Web/Member/index')}";
            })
        });
        function isWeiXin() {
...
<body>
    ...
    <div id="page_info" class="page_info" style="background-image: url('__IMG__/invitebg.png'); background-size: 100% auto" >
        <div class="invitecode">
            <div>下载蔬果先生App即可获得<span>15元</span>优惠券</div>
            <div>新用户注册时需输入推荐码</br>推荐ID：{$data.tuijiancode}</div>
        </div>
        <div class="appdown">
            <img src="__IMG__/click_to_download.png" id="download" />
        </div>
    </div>
</body>
