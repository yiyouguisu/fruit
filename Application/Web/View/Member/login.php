...
<body>
    <div class="login">
        <form action="{:U('Web/Member/login')}" method="post" onsubmit="return checkform();">
            ...
            <img alt="" src="__IMG__/login_bg.png" class="backImg" />
            <img alt="" src="__IMG__/login_logo.png" class="logoImg" />
            <div class="infoDiv">
                <div>
                    <img src="__IMG__/login_username.png" style="left:20px ; position:absolute; margin-top:10px" />
                    <input id="username" name="username" type="text" class="username" placeholder="请输入账号或手机号"  value="" />
                </div>
                <div >
                    <img src="__IMG__/login_password.png" style="left:20px ; position:absolute; margin-top:10px" />
                ...
                <div>
                    <input id="subbtn1" type="button" value="微信登录" class="toolSubmit" onclick="window.location.href='{:U('Member/wxlogin')}'" />
                </div>
                <div>
                    <a href="{:U('Web/Member/reg')}" target="_self" style="float: left; color: #ffffff;">注册账号{$code}</a>
                    <a href="{:U('Web/Member/forgot')}" target="_self" style="float: right; color: #ffffff;">忘记密码</a>
                </div>
