...
if (!defined('K_TCPDF_EXTERNAL_CONFIG')) {
	 ...
	 * document creator
	 */
	defined('PDF_CREATOR') or define('PDF_CREATOR','TCPDF');

	/**
	 * document author
	 */
	defined('PDF_AUTHOR') or define('PDF_AUTHOR','TCPDF');

	/**
	 * header title
	 */
	defined('PDF_HEADER_TITLE') or define('PDF_HEADER_TITLE','');

	/**
	 * header description string
	 */
	defined('PDF_HEADER_STRING') or define('PDF_HEADER_STRING',"www.dfp2p.com");

	/**
	 * image logo
	 */
	defined('PDF_HEADER_LOGO') or define('PDF_HEADER_LOGO','tcpdf_logo.jpg');

	/**
	 * header logo image width [mm]
	 */
	defined('PDF_HEADER_LOGO_WIDTH') or define('PDF_HEADER_LOGO_WIDTH',30);
	 ...
	 */
	defined('K_THAI_TOPCHARS') or define('K_THAI_TOPCHARS', true);
