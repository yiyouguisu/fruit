...
<?php } ?>
        ...
        <form method="get" action="<?php echo U('Admin/Product/outoff');?>">
        ...
        <form action="<?php echo U('Admin/Product/paction');?>" method="post" >
            <div class="table_list">
              ...
              <a href="javascript:;" class="unout" data-id="<?php echo ($vo['id']); ?>" >取消缺货</a>
            ...
            <div class="btn_wrap">
                <div class="btn_wrap_pd">
                    ...
                    <?php if(authcheck('Admin/Product/unouts')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="unouts">取消缺货</button><?php endif; ?>
