...
<?php } ?>
        <div style="width: 100%; height: 550px; border: #ccc solid 1px; float: right;" id="dituContent"></div>
    </div>
    <script language="javascript">
        ...
        a = "<?php echo ($store['lng']); ?>" + "|" + "<?php echo ($store['lat']); ?>";
        //alert(a);
        //markerArr = [{ title: "<?php echo ($store['title']); ?>", content: "门店所在位置", point: a}];
        markerArr=<?php echo ($markerArrStr); ?>;
        initMap();
        ...
        function createMap() {
            ...
            var point = new BMap.Point("<?php echo ($store['lng']); ?>", "<?php echo ($store['lat']); ?>");//定义一个中心点坐标
