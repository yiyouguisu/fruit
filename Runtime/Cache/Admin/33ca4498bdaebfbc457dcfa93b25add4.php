...
<?php } ?>
        ...
        <form method="get" action="<?php echo U('Admin/Store/index');?>">
            ...
            <div class="search_type cc mb10">
                <div class="mb10"> <span class="mr20">
                        ...
                        <select class="select_2" name="searchtype" style="width:70px;">
                            <option value='0' <?php if( $searchtype == '0' ): ?>selected<?php endif; ?>>店铺名称</option>
                            <option value='1' <?php if( $searchtype == '1' ): ?>selected<?php endif; ?>>店铺简介</option>
        ...
        <form action="<?php echo U('Admin/Store/action');?>" method="post" >
            <div class="table_list">
                <table width="100%" cellspacing="0">
                    ...
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td align="center" >
                              <?php if($vo['thumb'] == null): ?>暂无缩略图<?php else: ?><img width="80" height="80" src="<?php echo ($vo["thumb"]); ?>" /><?php endif; ?>
                            </td>
                            <td align="center" ><?php echo (date("Y-m-d H:i:s",$vo["inputtime"])); ?></td>
                            <td align="center" ><?php echo getAuser($vo['uid']);?></td>
                            <td align="center" > 
              <a href="<?php echo U('Admin/Store/tongji',array('id'=>$vo['id']));?>" >销售统计</a> |
              <?php if(authcheck('Admin/Store/review')): ?><!-- <a href="<?php echo U('Admin/Store/review',array('id'=>$vo['id']));?>" >审核</a> |
                <?php else: ?>
                 <font color="#cccccc">审核</font><?php endif; ?>  -->
                                <?php if(authcheck('Admin/Store/edit')): ?><a href="<?php echo U('Admin/Store/edit',array('id'=>$vo['id']));?>" >修改</a> |
                <?php else: ?>
                 <font color="#cccccc">修改</font> |<?php endif; ?> 
                            <?php if(authcheck('Admin/Store/delete')): ?><a href="<?php echo U('Admin/Store/delete',array('id'=>$vo['id']));?>"  class="del">删除</a> 
                <?php else: ?>
            ...
            <div class="btn_wrap">
                <div class="btn_wrap_pd">
                    <label class="mr20"><input type="checkbox" class="J_check_all" data-direction="y" data-checklist="J_check_y">全选</label>   
                     <?php if(authcheck('Admin/Store/listorder')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="listorder" >排序</button><?php endif; ?> 

                        <?php if(authcheck('Admin/Store/del')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="del">删除</button><?php endif; ?>
