...
<?php } ?>
   ...
   <div class="table_list">
        ...
        <form method="post" action="<?php echo U('Admin/Store/stock');?>">
   ...
   <table width="100%" cellspacing="0">
       <thead>
        ...
        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
            ...
            <td  align="center" >
                  <?php if(authcheck('Admin/Store/stockedit')): ?><a href="<?php echo U('Admin/Store/stockedit',array('id'=>$vo['id']));?>" >修改基本资料 </a>  |
                            <?php else: ?>
                            <font color="#cccccc">修改基本资料</font> |<?php endif; ?>  
                        <?php if(authcheck('Admin/Store/stockdelete')): ?><a href="<?php echo U('Admin/Store/stockdelete',array('id'=>$vo['id']));?>"  class="del">删除 </a> 
                            <?php else: ?>
