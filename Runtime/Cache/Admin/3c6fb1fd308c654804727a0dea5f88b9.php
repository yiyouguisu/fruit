...
<?php } ?>
        ...
        <form method="get" action="<?php echo U('Admin/Product/poutoff');?>">
        ...
        <form action="<?php echo U('Admin/Product/paction');?>" method="post" >
            <div class="table_list">
                ...
                <?php else: ?>
                 <font color="#cccccc">审核</font> |<?php endif; ?>  -->
                                <a href="<?php echo U('Admin/Product/unout',array('id'=>$vo['id']));?>" >取消缺货</a>  |
                                <a href="<?php echo U('Admin/Product/pedit',array('id'=>$vo['id']));?>" >修改</a>  |
              <a href="<?php echo U('Admin/Product/pdelete',array('id'=>$vo['id']));?>"  class="del">删除</a> 
            ...
            <div class="btn_wrap">
                <div class="btn_wrap_pd">
                    <label class="mr20"><input type="checkbox" class="J_check_all" data-direction="y" data-checklist="J_check_y">全选</label>   
                     <?php if(authcheck('Admin/Product/plistorder')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="listorder" >排序</button><?php endif; ?> 
                      <?php if(authcheck('Admin/Product/unpouts')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="unouts">取消缺货</button><?php endif; ?>
                         <?php if(authcheck('Admin/Product/ppushs')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="pushs">置顶</button><?php endif; ?>
                      <?php if(authcheck('Admin/Product/punpushs')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="unpushs">取消置顶</button><?php endif; ?>
                        <?php if(authcheck('Admin/Product/poff')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="off">下架</button><?php endif; ?>
                      <?php if(authcheck('Admin/Product/punoff')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="unoff">取消下架</button><?php endif; ?>
                        <?php if(authcheck('Admin/Product/pdel')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="del">删除</button><?php endif; ?>
