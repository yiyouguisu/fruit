...
<script type="text/javascript">
    $(function(){
        var type='<?php echo ($data["isleader"]); ?>';
        if(type==0){
            $(".leader").show();
        }else if(type==1) {
            $(".leader").hide();
...
<?php } ?>
        <div class="common-form">
            <form method="post" action="<?php echo U('Admin/Store/courieredit');?>">
                ...
                <div class="table_full">
                  ...
                  <li>
                    <label>
                      <input type='radio' name='isleader' value='1' <?php if($data['isleader'] == '1' ): ?>checked<?php endif; ?>>
                      <span>是</span></label>
                  </li>
                  <li>
                    <label>
                      <input type='radio' name='isleader' value='0' <?php if($data['isleader'] == '0' ): ?>checked<?php endif; ?>>
                      <span>否</span></label>
                  </li>
                </ul>
                                </td>
                            ...
                            <tr class="leader" style="display:none;">
                                ...
                                <td><select name="leader">
                                        ...
                                        <?php if(is_array($leader)): $i = 0; $__LIST__ = $leader;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($data['leader'] == $vo['id'] ): ?>selected<?php endif; ?>><?php echo ($vo["username"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </td>
                            </tr>
                            <tr>
