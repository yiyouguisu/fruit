       ...
       <!--  <div class="h_a">搜索</div>
        ...
        <div class="tab_nav" style="margin-bottom:0px">
            <ul class="J_tabs_nav1">
              <li class="current"><a href="<?php echo U('Admin/Package/errororder');?>">未处理订单</a><i>+<?php echo ((isset($errornum) && ($errornum !== ""))?($errornum):"0"); ?></i></li>
              <li class=""><a href="<?php echo U('Admin/Package/errordone');?>">已处理订单</a><i>+<?php echo ((isset($errordonenum) && ($errordonenum !== ""))?($errordonenum):"0"); ?></i></li>
            </ul>
        </div>
                ...
                <div class="liv_list">
                    ...
                    <div class="liv_btm">
                                ...
                                <div class="liv_g fl">
                                    <div class="liv_g1">
                                      ...
                                      <?php if( $v["product_type"] == '4'): ?>[称重商品]<?php endif; ?>
                                        ...
                                        <?php if(($v['isout']) == "1"): $num++ ?><span style="color:red">【缺货】</span><?php endif; ?>
                        ...
                        <div class="liv_right fl" style="width:45%;">
                            ...
                            <div class="fish_d fl">
                              <?php if($vo["paystyle"] == 1): if(($vo['pay_status']) == "1"): if(($vo['back_status']) == "0"): ?><a href="<?php echo U('Admin/Package/backorder',array('orderid'=>$vo['orderid']));?>">退货</a></br>
                                            <?php else: ?>
                                            已退货</br><?php endif; ?>
                                        <?php else: ?>
                                        <?php if(($vo['back_status']) == "0"): ?><a href="<?php echo U('Admin/Package/backorder',array('orderid'=>$vo['orderid']));?>">退货</a></br>
                                            <?php else: ?>
                                            已退货</br><?php endif; ?>
                                        <?php if($num > 0): if(($vo['change_status']) == "0"): ?><a href="javascript:;" onClick="omnipotent('selectid','<?php echo U('Admin/Package/changeorder',array('orderid'=>$vo['orderid']));?>','换货',1,500,350)">换货</a></br>
                                                    <?php else: ?>
                                                    已换货</br><?php endif; endif; endif; endif; ?> 
                                <?php if($vo["paystyle"] == 2): if(($vo['back_status']) == "0"): ?><a href="<?php echo U('Admin/Package/backorder',array('orderid'=>$vo['orderid']));?>">退货</a></br>
                                            <?php else: ?>
                                            已退货</br><?php endif; if($num > 0): if(($vo['change_status']) == "0"): ?><a href="javascript:;" onClick="omnipotent('selectid','<?php echo U('Admin/Package/changeorder',array('orderid'=>$vo['orderid']));?>','换货',1,500,350)">换货</a></br>
                                                    <?php else: ?>
                                                    已换货</br><?php endif; endif; endif; ?> 
                                <?php if($vo['pay_status'] == 0 and $vo['paystyle'] == 1 ): ?><a href="<?php echo U('Admin/Package/paynotice',array('orderid'=>$vo['orderid']));?>">提示支付</a></br><?php endif; ?> 
                                <?php if($vo['package_status'] == 1): ?><a href="<?php echo U('Admin/Package/packagedone',array('orderid'=>$vo['orderid'],'iserror'=>1));?>">包装完成</a></br><?php endif; ?>

                                <!-- <a href="javascript:;" onClick="omnipotent('selectid','<?php echo U('Admin/Order/dealagain',array('orderid'=>$vo['orderid']));?>','重新派发订单',1,300,180)">重新派发</a></br> -->
