       ...
       <!--  <div class="h_a">搜索</div>
        ...
        <div class="tab_nav" style="margin-bottom:0px">
            <ul class="J_tabs_nav1">
              <li class=""><a href="<?php echo U('Admin/Package/errororder');?>">未处理订单</a><i>+<?php echo ((isset($errornum) && ($errornum !== ""))?($errornum):"0"); ?></i></li>
              <li class="current"><a href="<?php echo U('Admin/Package/errordone');?>">已处理订单</a><i>+<?php echo ((isset($errordonenum) && ($errordonenum !== ""))?($errordonenum):"0"); ?></i></li>
            </ul>
        </div>
                ...
                <div class="liv_list">
                    ...
                    <div class="liv_btm">
                        ...
                        <div class="liv_right fl" style="width:45%;">
                            ...
                            <div class="fish_d fl">
                              <?php if($vo["paystyle"] == 1): if(($vo['pay_status']) == "1"): if(($vo['back_status']) == "0"): if(($vo['change_status']) == "1"): ?>已换货</br><?php endif; ?>
                                            <?php else: ?>
                                            已退货</br><?php endif; ?>
                                        <?php else: ?>
                                        <?php if(($vo['back_status']) == "0"): if(($vo['change_status']) == "1"): ?>已换货</br><?php endif; ?>
                                            <?php else: ?>
                                            已退货</br><?php endif; endif; endif; ?> 
                                <?php if($vo["paystyle"] == 2): if(($vo['back_status']) == "0"): if(($vo['change_status']) == "1"): ?>已换货</br><?php endif; ?>
                                            <?php else: ?>
                                            已退货</br><?php endif; ?>
                                    <?php if(($vo['package_status']) != "2"): ?><a href="<?php echo U('Admin/Package/packagedone',array('orderid'=>$vo['orderid']));?>">包装完成</a><?php endif; endif; ?> 
                                
                                <?php if(($vo['print_status']) == "1"): ?>已打印<?php endif; ?>
                                <!-- <input type="button" onClick="window.location.href='<?php echo U('Admin/Package/doout',array('orderid'=>$vo['orderid']));?>'" value="缺货"> -->
                            </div>
