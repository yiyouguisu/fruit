...
<?php } ?>
        ...
        <form method="get" action="<?php echo U('Admin/apply/company');?>">
                ...
                <table width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <td width="15%" align="left" >公司名称</td>
                            <td width="10%" align="center" >企业编号</td>
                    ...
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td align="center" > 
                               <?php if(($vo['isallot']) == "0"): if(($vo['status']) == "2"): if(authcheck('Admin/Company/add')): ?><a href="<?php echo U('Admin/Company/add',array('applyid'=>$vo['id']));?>" >分配账号</a> 
                <?php else: ?>
                 <font color="#cccccc">分配账号</font><?php endif; endif; endif; ?>
            <?php if(($vo['status']) == "1"): if(authcheck('Admin/apply/companyreview')): ?><a href="javascript:;" onClick="omnipotent('selectid','<?php echo U('Admin/apply/companyreview',array('id'=>$vo['id']));?>','审核',1,700,400)">审核</a>
                <?php else: ?>
                 <font color="#cccccc">审核</font><?php endif; endif; ?>
                            <?php if(authcheck('Admin/apply/companydelete')): ?><a href="<?php echo U('Admin/apply/companydelete',array('id'=>$vo['id']));?>"  class="del">删除</a> 
                <?php else: ?>
            ...
            <div class="btn_wrap">
                <div class="btn_wrap_pd">
                    <label class="mr20"><input type="checkbox" class="J_check_all" data-direction="y" data-checklist="J_check_y">全选</label>   
                        ...
                        <?php if(authcheck('Admin/apply/companydel')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="companydel">删除</button><?php endif; ?>
