...
<?php } ?>
        ...
        <form method="get" action="<?php echo U('Admin/Order/distributedone');?>">
                ...
                <table width="100%" cellspacing="0">
                 ...
                 <?php $money_total1=0;?>
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="productshow" data-id="<?php echo ($vo["id"]); ?>">
                            ...
                            <td align="center" > 
                                已派发给<?php echo getAuser($vo['puid']);?>包装</br>
                                <a href="<?php echo U('Admin/Order/cancel',array('orderid'=>$vo['orderid']));?>" class="cancel">取消订单</a></br>
                                <a href="javascript:;" onClick="omnipotent('selectid','<?php echo U('Admin/Order/orderprint',array('orderid'=>$vo['orderid']));?>','打印订单',1,390,250)">打印</a></br>
