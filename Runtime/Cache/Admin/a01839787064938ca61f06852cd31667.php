...
<?php } ?>
        ...
        <form method="get" action="<?php echo U('Admin/Order/neworder');?>">
                ...
                <table width="100%" cellspacing="0">
                 ...
                 <?php $money_total1=0;?>
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="productshow" data-id="<?php echo ($vo["id"]); ?>">
                            ...
                            <td align="center" >
                                <?php echo getordersendtime($vo['orderid']);?>
                            </td>
                            <td align="center" > 
                                <?php if($vo['status'] != 5): if(empty($vo['puid'])): if(authcheck('Admin/Order/deal')): ?><a href="javascript:;" onClick="omnipotent('selectid','<?php echo U('Admin/Order/deal',array('orderid'=>$vo['orderid']));?>','派发订单',1,300,180)">派发</a></br>
                                            <?php else: ?>
                                            <font color="#cccccc">派发</font></br><?php endif; ?> 
                                        <?php else: ?>
                                        已派发</br><?php endif; ?>
                                    <?php else: ?>
