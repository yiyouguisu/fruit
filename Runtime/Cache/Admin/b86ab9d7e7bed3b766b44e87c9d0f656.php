...
<?php } ?>
   ...
   <div class="table_list">
        ...
        <form method="get" action="<?php echo U('Admin/Push/store');?>">
        ...
        <form action="<?php echo U('Admin/Push/sdel');?>" method="post" >
        ...
        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
            ...
            <td  align="center" >
              <?php if(authcheck('Admin/Push/pushsagain')): ?><a href="<?php echo U('Admin/Push/pushsagain',array('id'=>$vo['id']));?>">再次推送 </a> |
                  <?php else: ?>
                  <font color="#cccccc">再次推送 </font> |<?php endif; ?> 
              <?php if(authcheck('Admin/Push/delete')): ?><a href="<?php echo U('Admin/Push/delete',array('id'=>$vo['id']));?>"  class="del">删除 </a> 
                  <?php else: ?>
        ...
        <div class="btn_wrap">
          <div class="btn_wrap_pd">
            ...
            <?php if(authcheck('Admin/Push/sdel')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="sdel">删除</button><?php endif; ?>
          </div>
        </div>
    </form>
 </div>
