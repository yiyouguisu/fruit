...
<?php } ?>
   ...
   <div class="table_list">
        ...
        <form method="post" action="<?php echo U('Admin/Store/financial');?>">
   ...
   <table width="100%" cellspacing="0">
       <thead>
        ...
        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
            ...
            <td  align="center" >
                  <?php if(authcheck('Admin/Store/financialedit')): ?><a href="<?php echo U('Admin/Store/financialedit',array('id'=>$vo['id']));?>" >修改基本资料 </a>  |
                            <?php else: ?>
                            <font color="#cccccc">修改基本资料</font> |<?php endif; ?>  
                        <?php if(authcheck('Admin/Store/financialdelete')): ?><a href="<?php echo U('Admin/Store/financialdelete',array('id'=>$vo['id']));?>"  class="del">删除 </a> 
                            <?php else: ?>
