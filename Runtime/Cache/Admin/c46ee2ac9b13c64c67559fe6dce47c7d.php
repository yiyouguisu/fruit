...
<?php } ?>
   ...
   <div class="table_list">
        ...
        <form method="post" action="<?php echo U('Admin/message/index');?>">
                ...
                <div class="mb10"> <span class="mr20">
                       ...
                       -
                        ...
                        <select class="select_2" name="status" style="width:70px;">
                            ...
                            <option value='1' <?php if( $_POST['status']== '1'): ?>selected<?php endif; ?>>已读</option>
                            <option value='0' <?php if( $_POST['status']== '0'): ?>selected<?php endif; ?>>未读</option>
                        </select>
                        关键字：
                        <select class="select_2" name="searchtype" >
                        <option value='0' <?php if( $searchtype == '0' ): ?>selected<?php endif; ?>>内容</option>
                        <option value='1' <?php if( $searchtype == '1' ): ?>selected<?php endif; ?>>用户昵称</option>
        ...
        <form action="<?php echo U('Admin/Message/del');?>" method="post" >
        ...
        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
            ...
            <td align="center"><?php echo getuserinfo($vo['tuid']);?></td>
            ...
            <td  align="center" >
                        <?php if(authcheck('Admin/message/delete')): ?><a href="<?php echo U('Admin/message/delete',array('id'=>$vo['id']));?>"  class="del">删除 </a> 
                            <?php else: ?>
        ...
        <div class="btn_wrap">
          <div class="btn_wrap_pd">
            ...
            <?php if(authcheck('Admin/Message/del')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="del">删除</button><?php endif; ?>
          </div>
        </div>
    </form>
 </div>
