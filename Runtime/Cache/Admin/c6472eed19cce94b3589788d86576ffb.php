            ...
            success: function (data) {
                if(data!=''){
                    ...
                    if (data != null && data.length > 0) {
                        ...
                        $(".jgbox").append(ahtml);
                        if(a!=0){
                            var servicearea='<?php echo ($data["servicearea"]); ?>';
...
<?php } ?>
        <div class="common-form">
            <form method="post"  action="<?php echo U('Admin/Store/edit');?>">
                ...
                <div class="table_full">
                    <table width="100%" class="table_form contentWrap">
                        <tbody>
                            ...
                            <!-- <tr>
                                <th width="80">登录名</th>
                                <td><input type="test" name="loginname" class="input" id="loginname" value="<?php echo ($storeuser["username"]); ?>"></td>
                            </tr>
                            <tr>
                                <th>登录密码</th>
                            ...
                            <tr>
                                <th>门店LOGO：</th>
                                <td>
                                    <input type="text" name="thumb" id="image" class="input length_5" value="<?php echo ($data["thumb"]); ?>" style="float: left"  runat="server" ondblclick='image_priview(this.value);'>&nbsp; <input type="button" class="button" value="选择上传" id="uploadify" > <span class="gray"> 双击文本框查看图片</span>
                                </td>
                            </tr>
                            <tr>
