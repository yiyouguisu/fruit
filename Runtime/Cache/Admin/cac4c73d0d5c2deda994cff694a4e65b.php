...
<?php } ?>
   ...
   <div class="table_list">
        ...
        <form method="post" action="<?php echo U('Admin/Store/packing');?>">
   ...
   <table width="100%" cellspacing="0">
       <thead>
          <tr>
            ...
            <td width="10%"  align="center" >包装订单总金额</td>
            <td width="10%"  align="center" >包装订单总数量</td>
        ...
        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
            ...
            <td align="center" ><?php echo getpackageorder_totalmoney($vo['id']);?></td>
            <td align="center" ><?php echo getpackageorder_totalnum($vo['id']);?></td>
            <td  align="center" >
                  <?php if(authcheck('Admin/Store/packingedit')): ?><a href="<?php echo U('Admin/Store/packingedit',array('id'=>$vo['id']));?>" >修改基本资料 </a>  |
                            <?php else: ?>
                            <font color="#cccccc">修改基本资料</font> |<?php endif; ?>  
                        <?php if(authcheck('Admin/Store/packingdelete')): ?><a href="<?php echo U('Admin/Store/packingdelete',array('id'=>$vo['id']));?>"  class="del">删除 </a> 
                            <?php else: ?>
