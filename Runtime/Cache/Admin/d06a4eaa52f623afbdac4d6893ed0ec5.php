...
<?php } ?>
        ...
        <form method="get" action="<?php echo U('Admin/Order/errororder');?>">
                ...
                <table width="100%" cellspacing="0">
                 ...
                 <?php $money_total1=0;?>
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="productshow" data-id="<?php echo ($vo["id"]); ?>">
                            ...
                            <td align="center" > 
                                <?php if($vo['error_status'] == 1): ?><a href="<?php echo U('Admin/Order/doerror',array('orderid'=>$vo['orderid']));?>">异常审核</a></br><?php endif; ?>
                                <?php if($vo['error_status'] == 2): if(empty($vo['relationorderid'])): ?><a href="javascript:;" onClick="omnipotent('selectid','<?php echo U('Admin/Order/addorder',array('orderid'=>$vo['orderid']));?>','新建订单',1,700,400)">新建订单</a></br>
                                        <?php else: ?>
                                        <a href="javascript:;" onClick="omnipotent('selectid','<?php echo U('Admin/Order/show',array('orderid'=>$vo['relationorderid']));?>','查看售后订单详情',1,700,400)">查看售后订单</a></br><?php endif; endif; ?>
                                <a href="javascript:;" onClick="omnipotent('selectid','<?php echo U('Admin/Order/feedbacklog',array('orderid'=>$vo['orderid']));?>','处理记录',1,700,400)">处理记录</a></br>
                                <a href="javascript:;" onClick="omnipotent('selectid','<?php echo U('Admin/Order/show',array('orderid'=>$vo['orderid']));?>','查看详情',1,700,400)">查看详情</a></br>
                            </td>
                        </tr>
