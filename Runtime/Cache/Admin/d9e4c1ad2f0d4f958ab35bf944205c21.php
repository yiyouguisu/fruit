                ...
                <div class="mb10"> <span class="mr20">
                      ...
                      性别：
                        ...
                        <select class="select_1" name="level">
                            <option value="" <?php if(empty($_POST['level'])): ?>selected<?php endif; ?>>全部</option>
                            <?php if(is_array($levelConfig)): $i = 0; $__LIST__ = $levelConfig;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if( $_POST['level']== $key): ?>selected<?php endif; ?>><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                        关键字：
       ...
       <thead>
        ...
        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
            ...
            <td align="center">
              ...
              <td align="center" ><?php echo getlevel($vo['id']);?></td>
