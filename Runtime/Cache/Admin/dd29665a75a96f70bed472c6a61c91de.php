...
<?php } ?>
        ...
        <form action="<?php echo U('Admin/Order/paynotices');?>" method="post" >
            <div class="table_list">
                <table width="100%" cellspacing="0">
                 ...
                 <?php $money_total1=0;?>
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="productshow" data-id="<?php echo ($vo["id"]); ?>">
                            ...
                            <td align="center" > 
                                <a href="<?php echo U('Admin/Order/paynotice',array('orderid'=>$vo['orderid']));?>">提示支付</a></br>
                                <a href="<?php echo U('Admin/Order/cancel',array('orderid'=>$vo['orderid']));?>" class="cancel">取消订单</a>
                            </td>
                        </tr>
                ...
                <div class="p10">
                    ...
                    <button class="btn btn_submit mr10 " type="submit" name="paynotices" value="paynotices">批量提示支付</button>
                    </form>
                </div>
            </div>
            ...
            <div class="btn_wrap">
                <div class="btn_wrap_pd">
                    <form method="post" action="<?php echo U('Admin/Orderexcel/excel');?>">
                            ...
                            <input type="hidden"  name="iswaitpay" value="1" >
