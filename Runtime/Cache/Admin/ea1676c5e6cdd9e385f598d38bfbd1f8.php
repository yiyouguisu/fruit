       ...
       <!--  <div class="h_a">搜索</div>
        ...
        <div class="tab_nav" style="margin-bottom:0px">
            <ul class="J_tabs_nav1">
              <li class="current"><a href="<?php echo U('Admin/Package/index');?>">全部订单</a><i>+<?php echo ((isset($allnum) && ($allnum !== ""))?($allnum):"0"); ?></i></li>
              <li class=""><a href="<?php echo U('Admin/Package/waitpackage');?>">待包装</a><i>+<?php echo ((isset($waitpackagenum) && ($waitpackagenum !== ""))?($waitpackagenum):"0"); ?></i></li>
        ...
        <form action="<?php echo U('Admin/Package/action');?>" method="post" >
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="liv_box">
                        ...
                        <div class="liv_btm">
                            <div class="liv_left fl" style="width: 55%;">
                                            ...
                                            <div class="liv_g fl">
                                                <div class="liv_g1">
                                                  ...
                                                  <?php if( $v["product_type"] == '4'): ?>[称重商品]<?php endif; ?>
                                                    ...
                                                    <?php if(($vo['package_status']) != "2"): if($v['isout'] == 1): ?><span style="color:red">【缺货】</span><?php endif; endif; ?>
                                            </div>
                                ...
                                <div class="liv_right fl" style="width:45%;">
                                    ...
                                    <?php else: ?>
                                    已打印<?php endif; ?>
                                <?php if(($vo['package_status']) != "2"): ?><input type="button" class="doout" data-url="<?php echo U('Admin/Package/doout',array('orderid'=>$vo['orderid']));?>" value="缺货处理"><?php endif; ?>  
                                    </div>
                ...
                <div class="p10">
                    ...
                    <?php if(authcheck('Admin/Package/packagedones')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="packagedones">批量包装完成</button><?php endif; ?>
