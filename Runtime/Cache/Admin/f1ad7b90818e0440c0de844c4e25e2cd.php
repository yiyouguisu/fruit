...
<?php } ?>
        ...
        <form method="get" action="<?php echo U('Admin/Ad/index');?>">
            ...
            <div class="table_list">
                <table width="100%" cellspacing="0">
                    ...
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td align="left" >
                                <?php if(($vo['type']) == "1"): ?>链接广告<?php endif; ?>
                                <?php if(($vo['type']) == "2"): ?>商品广告<?php endif; ?>
                                <?php if(($vo['type']) == "3"): ?>图文广告<?php endif; ?>
                            </td>
                           
                            <td align="center" ><?php if($vo["status"] == 0): ?><span style="color: red">未审核</span><?php endif; ?>
