...
<head>
 ...
 $(document).ready(function () {
        ...
        var template_star = '<img src="/Public/Web/images/icon_star.png" />';
        var template_grey_star = '<img src="/Public/Web/images/icon_Grey_stars.png" style="width:20px" />'
        //循环列
        ...
        function loaded(type) {
            ...
            $.post(
                "<?php echo U('Web/Product/get_product_evaluatelist');?>", {
                    "Page": page,
...
<body>
    <div id="page_info" class="page_info">
        <div class="discussHead">
            ...
            <h1>评论</h1>
            <!--<img alt="" src="/Public/Web/images/pointHeadBg.png" class="backImg" />-->
            <div class="diswidth" onclick="loaded(1);">
                <h2>不错哟</h2>
                <span style="height: <?php echo ($hign); ?>%"></span>
                <h1><?php echo ($hign); ?>%</h1>
            </div>
            <div class="diswidth" onclick="loaded(2);">
                <h2>一般</h2>
                <span style="height: <?php echo ($middle); ?>%"></span>
                <h1><?php echo ($middle); ?>%</h1>
            </div>
            <div class="diswidth" onclick="loaded(3);">
                <h2>小失落</h2>
                <span style="height: <?php echo ($low); ?>%"></span>
                <h1><?php echo ($low); ?>%</h1>
            </div>
        </div>
